namespace LesserKnown.VoxelGenerator
{
    /// <summary>
    /// The regular cell data holds info about the triangulation used for a single equivalence class in the modified marching cubes algo
    /// </summary>
    public class RegularCellData
    {
        ...
        public RegularCellData(long geometryCounts, byte[] vertexIndex)
        {
    ...
    //The transition cell data holds info about the triangulation used for a single equivalence class in the Transvoxel Algorithm
    public class TransitionCellData
    {
        long geometryCounts;
        byte[] vertexIndex = new byte[36];

		public TransitionCellData(long geometryCounts, byte[] vertexIndex)
		{
			this.geometryCounts = geometryCounts;
			this.vertexIndex = vertexIndex;
		}
	...
	/// <summary>
	/// The regular cell data table holds the triangulation data for all 16 distinct classes to which a case can be mapped by the marching cubes
	/// </summary>
	public static class TrinagulationData
	{
		readonly static byte[] cellBytes = new byte[256]
	   {
	...
	0x03, 0x04, 0x04, 0x03, 0x04, 0x03, 0x0D, 0x01, 0x04, 0x0D, 0x03, 0x01, 0x03, 0x01, 0x01, 0x00
		...
		readonly static RegularCellData[] regularCellCombinations =
		{
		...
		readonly static ushort[][] regularVertexData = new ushort[][]
			{
				new ushort[]{},
	...
	new ushort[]{}
		...
		readonly static byte[] transitionCellClass = new byte[512]
		{
	...
	0x85, 0x85, 0x8B, 0x04, 0xA6, 0x25, 0x07, 0x82, 0x84, 0x84, 0x85, 0x81, 0x04, 0x82, 0x81, 0x80
		...
		readonly static TransitionCellData[] transitionCellData =
		{
	...
	new TransitionCellData(0xA8, new byte[] { 0, 1, 5, 1, 4, 5, 1, 2, 4, 2, 3, 4, 2, 6, 3, 3, 6, 7, 0, 8, 9, 0, 5, 8 })
		...
		readonly static byte[] transitionCornerData = new byte[13]
		{
			0x30, 0x21, 0x20, 0x12, 0x40, 0x82, 0x10, 0x81, 0x80, 0x37, 0x27, 0x17, 0x87
		};

		readonly static ushort[][] transitionVertexData = new ushort[][]
		{
			new ushort[]{},
